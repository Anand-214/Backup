...
Date:- 18/10/2021
Description:- Script to greet the user every time the terminal is opened and display the current date and time in a modified way.
...
if [[ $hour -ge 5 && $hour -lt 12 ]]        #if time is between 5AM to 12PM
then
    echo "Good Morning $USER!!Have a nice day."  #greetings for the user
elif [[ $hour -ge 12 && $hour -lt 13 ]]      #if time is between 12PM to 1PM.   
then
    echo "Good noon $USER!!Have a nice day."     
elif [[ $hour -ge 13 && $hour -lt 17 ]]      #if the time is between 1PM to 5PM
then
    echo "Good afternoon $USER!!Have a nice day."
elif [[ $hour -ge 17 && $hour -lt 21 ]]       #if the time is between 5PM to 9PM.
then                                      
